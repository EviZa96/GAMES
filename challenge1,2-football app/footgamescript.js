...
2.The first player in any player array is the
 ...
 For Bayern Munich(team 1)create one variable('gk')with 
 the goalkeeper's name,and one array('fieldPlayers')with
  all the remaining 10 field players.

3.Create an array 'allPlayers' containing all players of both teams(22 players).
4.During the game,Bayer Munich (team 1)used 3 substitude players.So create a new array
('playersFinal')containing all the original team1 players plus
'Thiago','Coutinbo' and 'Perisic'

5.Based on the game.odds object create one variable for each odd(called 'team1),'draw' and 'team2')
6.Write a function ('printGoals')that receives an
 arbitrary number of player names(NOT an array)and
  prints each o them to the console,along with the
   number of goals who were scored(number of 
    player names passed in)
7.The team with the lower add is more likely to win.
Print to the console which team is more likely to win,WITHOUT
using an if/else statement or the ternary operator

TEST DATA FOR 6:Use players 'Davies','Muller','Lewandoski'
and 'Kimich'.Then, call the function again with players form game.scorerd
*/
